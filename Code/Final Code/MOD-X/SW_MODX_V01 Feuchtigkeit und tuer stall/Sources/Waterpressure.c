...
#define MODULE_WATER		SENSOR_WATER
...
void WaterSensor_ADC(void)
{
 ...
 void WaterSensor_PreparePacket(void)
 {
 	...
 	CC2500_sendPacketArr[2] += MODULE_WATER;
 	CC2500_sendPacketArr[2] = (byte)(WaterSensor_ADCValue >> 8);
 	CC2500_sendPacketArr[3] = (byte)(WaterSensor_ADCValue & 0x00FF);
 }