...
//    Serial.println(GDO0_State);
    ...
    */
    ...
    byte c;
  // Read length byte
        PacketLength = (byte)ReadReg(CC2500_RXFIFO);
      byte dataRecv[PacketLength];
...
//                }
//            }
              dataRecv[i] = ReadReg(CC2500_RXFIFO);
              
              //Serial.println(dataRecv[i], HEX);
          }

          switch(dataRecv[0] >> 4){
            case 0b0000:
              Serial.print(dataRecv[0] >> 4, HEX);
              Serial.println(", Y");
              break;
          ...
          switch(dataRecv[0] & 0x0F){
            case 0b0001:
              Serial.print(dataRecv[0] & 0xF, HEX);
              Serial.println(", DOOR");
              break;
