...
This example program initializes the BME680 to use hardware SPI for communications. The library does
...
void setup()
{
  ...
  */
  ...
  while (!BME680.begin(SPI_CS_PIN, SPI_MOSI_PIN, SPI_MISO_PIN, SPI_SCK_PIN)) // Start using hardware SPI protocol
  {
