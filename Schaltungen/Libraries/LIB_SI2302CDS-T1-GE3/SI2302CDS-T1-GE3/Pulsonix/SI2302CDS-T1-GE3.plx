...
//184090/620563/2.49/3/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "SI2302CDS-T1-GE3" (originalName "SI2302CDS-T1-GE3")
	...
	(compDef "SI2302CDS-T1-GE3" (originalName "SI2302CDS-T1-GE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SI2302CDS-T1-GE3"))
		...
		(attr "Manufacturer_Part_Number" "SI2302CDS-T1-GE3")
		(attr "Mouser Part Number" "781-SI2302CDS-T1-GE3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Semiconductors/SI2302CDS-T1-GE3?qs=IRuQNBqMOcmu69KRt6rZUQ%3D%3D")
		(attr "Arrow Part Number" "SI2302CDS-T1-GE3")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/si2302cds-t1-ge3/vishay?region=nac")
		(attr "Description" "SI2302CDS-T1-GE3, N-channel MOSFET Transistor 2.6 A 20 V, 3-Pin SOT-23")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-DGA23/1579559.pdf")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "SI2302CDS-T1-GE3.stp")
